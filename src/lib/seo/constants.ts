...
export const MARKETING_ROUTES: Record<string, { priority: number; changeFrequency: "weekly" | "monthly" | "yearly" }> = {
  ...
  "/pickleball-in-nagpur": { priority: 0.85, changeFrequency: "monthly" },
  "/pickleball-in-thane": { priority: 0.85, changeFrequency: "monthly" },
  "/pickleball-in-navi-mumbai": { priority: 0.85, changeFrequency: "monthly" },
  "/pickleball-in-kolkata": { priority: 0.85, changeFrequency: "monthly" },
  "/pickleball-in-indore": { priority: 0.85, changeFrequency: "monthly" },
  "/pickleball-in-jaipur": { priority: 0.85, changeFrequency: "monthly" },
  "/pickleball-in-lucknow": { priority: 0.85, changeFrequency: "monthly" },
