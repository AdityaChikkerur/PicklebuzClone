-- ============================================================================
-- PickleBuzz — 035_mumbai_venues.sql
-- Verified dedicated pickleball courts across Mumbai (master list).
-- Run AFTER 034_pune_venues_additional.sql.
-- ============================================================================
...
begin
  ...
  insert into _mumbai_venues (name, location, contact, rating, open_from, open_to, amenities) values
    ...
    ('House Of Pickleball : HOP', '2nd Floor Terrace, HOP, Cadbury Junction, Dev Corpora, B-Win, Thane', null, 4.8, '00:00', '23:59', '["sports club","pickleball court","24 hours"]'),
